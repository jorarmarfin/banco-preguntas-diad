                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    type="text"
                                    wire:model="form.key"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('form.key') border-red-300 @enderror"
                                    id="key"
                                    placeholder="Ingrese la clave de configuración">
                                @error('form.key')
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('form.value') border-red-300 @enderror"
                                    id="value"
                                    placeholder="Ingrese el valor de configuración">
                                @error('form.value')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
            ...
            @forelse($settings as $setting)
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {{ $setting->created_at ? $setting->created_at->format('d/m/Y H:i') : 'N/A' }}
                    </td>
