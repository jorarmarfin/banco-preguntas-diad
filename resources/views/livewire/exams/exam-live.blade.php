<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Gestión de exámenes</h2>
                <p class="text-sm text-gray-500 mt-1">
                    Crea, edita y elimina exámenes para tus cursos y gestiona las preguntas asociadas a cada uno de ellos.
                </p>
            </div>
        </div>
    </div>
